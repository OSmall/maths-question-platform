  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <span
          aria-hidden="true"
          className="pointer-events-none shrink-0 text-base text-muted-foreground group-aria-expanded/accordion-trigger:hidden"
        ...
        <span
          aria-hidden="true"
          className="pointer-events-none hidden shrink-0 text-base text-muted-foreground group-aria-expanded/accordion-trigger:inline"
          data-slot="accordion-trigger-icon"
        >
          -
        </span>
