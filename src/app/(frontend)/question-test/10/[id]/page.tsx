...
import { Attempt10Renderer } from '@/components/question-test/attempt-10-renderer'
...
export default async function QuestionTest10Page({ params }: QuestionTestPageProps) {
  ...
  return questionResult.match(
    (question) => (
      <div className="min-h-screen w-full bg-[radial-gradient(circle_at_top,_#f4f4f5_0%,_#fafafa_45%,_#ffffff_100%)] px-4 py-8 dark:bg-[radial-gradient(circle_at_top,_#27272a_0%,_#09090b_50%,_#020617_100%)] md:px-6 md:py-10">
        {isDraftMode ? <RefreshRouteOnSave /> : null}
        <div className="mx-auto flex w-full justify-center">
          <Attempt10Renderer question={question} />
        </div>
      </div>
    ),
    (err) => {
