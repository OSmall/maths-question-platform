...
import { Attempt9Renderer } from '@/components/question-test/attempt-9-renderer'
...
export default async function QuestionTest9Page({ params }: QuestionTestPageProps) {
  ...
  return questionResult.match(
    (question) => (
      <div className="min-h-screen w-full bg-[radial-gradient(circle_at_20%_10%,_#d9f8ff_0%,_#ecfeff_40%,_#f8fafc_100%)] px-4 py-8 dark:bg-[radial-gradient(circle_at_40%_-20%,_#164e63_0%,_#020617_38%,_#000000_100%)] md:px-6 md:py-10">
        {isDraftMode ? <RefreshRouteOnSave /> : null}
        <div className="mx-auto flex w-full justify-center">
          <Attempt9Renderer question={question} />
        </div>
      </div>
    ),
    (err) => {
